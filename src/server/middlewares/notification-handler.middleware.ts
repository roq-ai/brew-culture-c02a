...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.create': { roles: ['owner'], key: 'supplier-joined', tenantPath: ['organization', 'user'], userPath: [] },
  'product.create': {
    roles: ['owner', 'supplier'],
    key: 'product-added',
    tenantPath: ['organization', 'product'],
    userPath: [],
  },
  'tutorial.create': {
    roles: ['owner', 'supplier'],
    key: 'tutorial-created',
    tenantPath: ['organization', 'user', 'tutorial'],
    userPath: [],
  },
  'user.delete': { roles: ['owner'], key: 'supplier-left', tenantPath: ['organization', 'user'], userPath: [] },
  'product.delete': {
    roles: ['owner', 'supplier'],
    key: 'product-deleted',
    tenantPath: ['organization', 'product'],
...
const tenantRoles: string[] = ['owner', 'supplier'];
